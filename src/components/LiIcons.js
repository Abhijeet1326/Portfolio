...
const LiIcons = ({reference}) => {
  ...
  return (
    <figure className=' absolute left-0 stroke-dark dark:stroke-blue-500'>
        <svg className='-rotate-90 md:w-[60px] md:h-[60px] xs:w-[40px] xs:h-[40px]' width="75" widths="75" viewBox='0 0 100 100'>
