...
const NavBar = () => {
    ...
    return (
        ...
        <nav className='flex justify-center items-center flex-wrap'>
            <motion.a href='https://www.google.com' target={"_blank"} className='w-6 mx-3'
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}>
            ...
            <motion.a href='https://www.google.com' target={"_blank"}className='w-6 ml-3'
            whileHover={{y:-2}}
        ...
        <nav className='flex justify-center items-center flex-wrap mt-2'>
            <motion.a href='https://www.google.com' target={"_blank"} className='w-6 mx-3 sm:mx-1'
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}><TwitterIcon/></motion.a>
            <motion.a href='https://www.google.com' target={"_blank"} className='w-6 mx-3 bg-light rounded-full dark:bg-dark sm:mx-1'
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}><GithubIcon/></motion.a>
            <motion.a href='https://www.google.com' target={"_blank"} className='w-6 mx-3 sm:mx-1'
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}><LinkedInIcon/></motion.a>
            <motion.a href='https://www.google.com' target={"_blank"} className='w-6 ml-3 sm:mx-1'
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}><InstagramIcon/></motion.a>
